...
def myloss(recon, label):
    loss_calc = torch.norm(recon-label,p=2)/torch.norm(label,p=2)
    return loss_calc

def Training(network, device, image_path, epochs=100, batch_size=1, LearningRate=1e-4):
    ...
    return recon, acc_im, label, loss_List
...
if __name__ == "__main__":
    ...
    #imageroute = '/home/daedalus1-raid1/omer-data/brain_flair/noPF/'
    imageroute = './database/'
